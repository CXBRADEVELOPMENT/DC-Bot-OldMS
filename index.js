...
let activities = [{ name: "HazeV", options: { type: "PLAYING" } }, {
    name: "TS3: ts.HazeV.eu",
...
bot.on("message", async message => {
    ...
    if (message.content == ".ms-123456789") {
        message.delete();
        message.channel.send("Samma Ihr Nudels!")
        message.channel.send("C-Development lässt grüßen, und ach ja...")
        message.channel.send(`<@918923044540547105> ist cool`)
    }
